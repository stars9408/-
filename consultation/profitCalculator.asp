...
<% 
	...
	Do until rs.eof   
			...
			<td class="a_right"><font color="#0000FF"><b><%=FormatNumber(amount_money_SUM_TOT,0)%>원</b></td>
			<td class="a_right"><font color="#0000FF"><b><%=FormatNumber(amount_money_total,0)%>원</b></td>	

			<%
			Loop	
			%>

			<td class="a_right"><font color="#0000FF"><b><%=FormatNumber(Total_amount_money_SUM,0)%>원</b></td>
			<td class="a_right"><font color="#0000FF"><b><%=FormatNumber(Total_earn_money_Sum,0)%>원</b></td>
		</tr>
		</table>
	...
	<table border="0" cellpadding="0" cellspacing="0" class="tb_basic" style="width:1000px">
		...
		<tr> 
			<th rowspan="2">Q<%=matchQuarter%></th>
		</tr>
		<tr> 
			<td class="a_right"><font color="#0000FF"><b><%=FormatNumber(amount_money_SUM_TOT5,0)%>원</b></td>
			<td class="a_right"><font color="#0000FF"><b><%=FormatNumber(amount_money_SUM_TOT4,0)%>원</b></td>
			<td class="a_right"><font color="#0000FF"><b><%=FormatNumber(amount_money_SUM_TOT5 + amount_money_SUM_TOT4,0)%>원</b></td>
			<td class="a_right"><font color="#0000FF"><b><%=FormatNumber(amount_money_total5,0)%>원</b></td>
			<td class="a_right"><font color="#0000FF"><b><%=FormatNumber(amount_money_total4,0)%>원</b></td>
			<td class="a_right"><font color="#0000FF"><b><%=FormatNumber(amount_money_total5 + amount_money_total4,0)%>원</b></td>
		</tr>
	</table>
	<br><br>
	<div style = "clear:both;"></div>
...
%>
		...
		%>
			<tr>
				<th><font color="#0000FF"><b>소계a</b></th>
				<th><font color="#0000FF"><b><%=FormatNumber(amount_money_SUM_Team_Total,0)%>원</b></th>
				<th><font color="#0000FF"><b><%=FormatNumber(Product_buy_price_Team_Total,0)%>원</b></th>
				<th><font color="#0000FF"><b><%=FormatNumber(exe_Rs_pay_amount_SUMTeam_Total,0)%>원</b></th>
			</tr>
...
%>
		...
		%>
			...
			<div style="float:left;clear:both;width:100%;height:2px;background:red;"></div>
<%
			If currentmonth = month1 Then
				monthnow = month2
				currentmonth = month2
